...
//	FEditorModeRegistry::Get().RegisterMode<FDragonFabrikSolverEditMode>(DragonFabrikSolverEditModes::DragonFabrikSolver, LOCTEXT("DragonFabrikSolverEditMode", "DragonFabrikSolver"), FSlateIcon(), false);
	...
	FEditorModeRegistry::Get().RegisterMode<FChineseDragonSolverEditMode>(ChineseDragonSolverEditModes::ChineseDragonSolver, LOCTEXT("ChineseDragonSolverEditMode", "ChineseDragonSolver"), FSlateIcon(), false);

	FEditorModeRegistry::Get().RegisterMode<FTailSolverEditMode>(TailSolverEditModes::TailSolver, LOCTEXT("TailSolverEditMode", "TailSolver"), FSlateIcon(), false);
...
void FDragonIKPluginEditorModule::ShutdownModule()
{
	...
	FEditorModeRegistry::Get().UnregisterMode(ChineseDragonSolverEditModes::ChineseDragonSolver);

	FEditorModeRegistry::Get().UnregisterMode(TailSolverEditModes::TailSolver);
