...
public:
	...
	UPROPERTY()
	UDragonIKTraceManagerComponent* Dragon_Trace_Manager = nullptr;
...
*/
	...
	*/
	...
	UPROPERTY()
	UDragonIKFootStepsComponent* dragon_footsteps_component = nullptr;
...
//	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = Settings, meta = (DisplayName = "Automatic Foot Height Detection", PinHiddenByDefault))
	...
	UPROPERTY()
	AActor* Character_Actor = nullptr;
